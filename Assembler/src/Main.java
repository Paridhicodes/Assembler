        ...
        try{
            ...
            while ((inputLine = reader.readLine()) != null) {
                ...
                if(len==3){
                    ...
                    if(str2.equals("CLA") || str2.equals("STP")){
                    ...
                    if(!res2){
                        ...
                        if(str2.equals("BRN") && labels.containsKey(str3)){
                            pneumonic.put(str2,hm.get(str2));
                            continue;
                        }
                        if(str2.equals("BRN") && !labels.containsKey(str3)){
                            System.out.println("Label not declared!");
                            return;
                        }
                        pneumonic.put(str2,hm.get(str2));
                    }
            ...
            try{
                ...
                while ((inputLine = reader.readLine()) != null) {
                    ...
                    if(len>1){
                        ...
                        if(len==3){
                            if(arr[1].equals("BRN") && labels.containsKey(arr[2])){
                                str=str+toBinary(labels.get(arr[0]))+" "+hm.get(arr[1]);
